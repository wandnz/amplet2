...
int main(void) {
    ...
    struct opt_t options[] = {
        ...
        {NULL, "command", 1},
        {"foo.example.com", "a", 0},
        {"bar.example.com", "b", -(2<<15)},
        {"baz.example.com", "c", 2<<15},
        {"a.b.c.d.e.f.g.h.i.j.k.l.m.n.o.p.q.r.s.t.u.v.w.x.y.z", "a", 0},
        {"a.b.c.d.e.f.g.h.i.j.k.l.m.n.o.p.q.r.s.t.u.v.w.x.y.z", "a", -(2<<16)},
        {"a.b.c.d.e.f.g.h.i.j.k.l.m.n.o.p.q.r.s.t.u.v.w.x.y.z", "a", 2<<16},
        {"a", "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ", 0},
        {"b", "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ", -(2<<31)},
        {"c", "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ", 2 << 31},
    };
